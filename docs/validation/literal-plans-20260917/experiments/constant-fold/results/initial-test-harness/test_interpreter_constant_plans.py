"""Folded plans preserve dynamic behavior and the recursive numeric semantics."""
...
def test_safe_constant_subtrees_preserve_result_types_and_signed_zero(source, value):
...
def test_warning_policy_and_left_to_right_errors_are_not_folded(source, setting):
    expression = IndexExpr.parse(source)
...
def test_mutable_array_constants_are_not_retained_in_folded_plans():
