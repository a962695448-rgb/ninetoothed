...
class TensorRef:
    ...
    def read(self, mask=True, other=None):
        ...
        return self._read_access(coordinates, valid, other, whole_tensor=True)

    def _read_access(self, coordinates, valid, other=None, *, whole_tensor=False):
        if other is None:
        ...
        if whole_tensor and (
            ...
            np.copyto(result, self.array, where=valid)
        else:
