...
实际验证源码：`adf658e6077768f22af7d3cce2e6b3efdb9dc3c0`。本目录仅记录 CPU 检查与安装包回放；后续实际 A100 回归另存于 [a100_value_mapping_20260913](../a100_value_mapping_20260913/README.md)，不改写本目录原件。
