"""Record result-mapping CPU checks, installed replay and legacy compatibility."""
...
files = [
    ...
    "test_interpreter_provenance", "test_interpreter_value_mapping", "test_ssa_application_lowering", "test_ssa_first_backend_lowering",
